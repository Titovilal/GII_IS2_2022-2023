...
public class VM_AddHistorialPaciente extends javax.swing.JFrame {
    ...
    public void lanzarError(String str) {
        labelError.setForeground(Color.RED);
        labelError.setText(str);
    }

    public boolean addHistorialBD() {
        if (camposRellenados()) {
            return AccesoBD.addHistorialPacienteBD(
                    textDNI.getText(),
                    textFecha.getText(),
                    textEnfermedad.getText());
        }
        else{
            return false;
        }
    ...
    public boolean camposRellenados() {
        if (textDNI.getText().isBlank() || textFecha.getText().isBlank()
                || textEnfermedad.getText().isBlank()) {
            lanzarError("Rellena todos los campos para añadir historial");
            return false;
        } else {
            return true;
        }
