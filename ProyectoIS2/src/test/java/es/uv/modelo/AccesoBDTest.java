...
//    // </editor-fold> 
    ...
    public void testObtenerHistorialBD() {
        ...
        String apellidosEsperados = "de barranquilla";
        HistorialPaciente historial = AccesoBD.obtenerHistorialBD(dni);
        String apellidos = historial.getApellidosPaciente();
        assertEquals(apellidosEsperados, apellidos);
    }
    /**
    ...
    public void testAddHistorialPacienteTodoCorrectoBD() {
        ...
        String dni = "01234567A";
        String fecha = "1986-12-12";
        String enfermedad = "coronavirus";
     ...
     */
    @Test
    public void testAddHistorialPacienteEnfermedadNoValidaBD() {
        System.out.println("addHistorialPacienteBD");
        String dni = "01234567A";
        String fecha = "2007-12-12";
        String enfermedad = "";
        boolean expResult = false;
        boolean result = AccesoBD.addHistorialPacienteBD(dni, fecha, enfermedad);
        assertEquals(expResult, result);
